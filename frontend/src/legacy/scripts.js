...
//   var post_div_padding_left = parseFloat(
//     post_div_style.getPropertyValue("padding-left")
//   );
//   var post_div_padding_right = parseFloat(
//     post_div_style.getPropertyValue("padding-right")
//   );
//   var post_div_free_space =
//     post_div_width - post_div_padding_left - post_div_padding_right;
...
//   var my_exist_progress = document.getElementById(
//     "progress_" + elem.parentNode.href
//   );
...
//       img_span.style.left =
//         (document.documentElement.clientWidth - elem.width) / 2 + "px";
//       elem.setAttribute(
//         "onclick",
//         "gallery(this,'" + image_width + "'); return false"
//       );
//       img_span.style.backgroundColor =
//         post_div_style.getPropertyValue("background-color");

//       var pc_div = document.createElement("div");
//       pc_div.innerHTML =
//         '<p><img class="text_img" src="styles/loading.gif" alt="" title="">Загрузка оригинала...</span>';
...
//   var my_exist_progress = document.getElementById(
//     "progress_" + elem.parentNode.parentNode.id
//   );
...
//       elem.setAttribute(
//         "onclick",
//         "show_image(this,'" + image_width + "'); return false"
//       );
...
//       for_id +
//       ' <span style="cursor: pointer; color: red;" title="Отменить" onclick="remove_reply()">(x)</span>';
//     window.scroll(0, 0);
//     var selectedText = window.getSelection();

//     if (selectedText != "") {
//       selectedText = selectedText.toString();
//       replay_form.form_textarea.value =
//         replay_form.form_textarea.value +
//         ">>" +
//         for_id +
//         " [quote]" +
...
//     } else {
//       replay_form.form_textarea.value =
//         replay_form.form_textarea.value + ">>" + for_id + " ";
//     }
...
//       } else {
//         var new_comments_div =
//           document.getElementById("new_comments").firstChild;
...
//   var cc_timeout = setTimeout(function () {
//     cc_xmlhttp.abort();
//     show_state("red");
//   }, 8000);
// }
...
//     if (color == "red") {
//       state_button.innerHTML =
//         '<img src="styles/button_red.png" title="Автоподгрузке не удалось проверить наличие новых комментариев.">';
//     } else if (color == "blue") {
//       state_button.innerHTML =
//         '<img src="styles/button_blue.png" title="Идет проверка новых комментариев...">';
//     } else {
//       state_button.innerHTML =
//         '<img src="styles/button_green.png" title="Автоподгрузка новых комментариев работает нормально.">';
//     }
//   }
// }
...
//       newNode.style.left =
//         event.target.parentNode.parentNode.offsetLeft + 30 + "px";
//       document.body.appendChild(newNode);

//       if (
//         (parseFloat(newNode.style.top) < preview_top && preview_top > 0) ||
//         preview_top == 0
//       ) {
...
//       if (
//         parseFloat(newNode.style.top) + newNode.offsetHeight + 50 >
//         preview_bottom
//       ) {
...
//         event.target.parentNode.parentNode.offsetLeft + 30 + "px";
//       newNode.innerHTML =
//         '<p><img class="text_img" src="styles/loading.gif" alt="" title="">На этой странице комментарий не найден.<br>Идет поиск по базе данных...</p><span class="info">Комментарий №' +
//         comment_id +
//         "</span>";
//       document.body.appendChild(newNode);
...
//           if (
//             pc_xmlhttp.readyState == 4 &&
//             pc_xmlhttp.status == 200 &&
//             pc_xmlhttp.responseText != ""
//           ) {
...
//   if (
//     (delite_div && preview_top > mouse_location) ||
//     (delite_div && preview_bottom < mouse_location)
//   ) {
...
//       comment.style.border = original_style_border;
//     }, 3000);
//   }
// }
...
//   var smile_box = document.getElementById("smiles_" + form_id);
//   smile_box.innerHTML =
//     '<img class="text_img" src="styles/loading.gif" alt="" title="">';
